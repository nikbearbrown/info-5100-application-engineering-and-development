# Research: Chapter 06 — Designing the Person into the Application
## Programming with Java: An Object-Oriented Practicum

**Chapter one-line:** Students learn to model users and authentication as first-class objects — not as a database lookup, but as a designed part of the object system.
...
### What is settled
The settled instructional core is that introductory application engineering students need executable mental models, not just syntax exposure. Java's type system, class model, object references, collections, exceptions, GUI APIs, and testing tools are documented in official specifications and API references, while programming-education research shows that students learn these concepts more reliably when they predict, trace, test, and explain code. For this chapter, the author can confidently treat Person versus UserAccount, authentication sequence, password hashing concept, Map-based directories, threat-model-lite thinking, and AI security gates as a design-and-verification problem, not only an implementation topic.
...
- **Jerome H. Saltzer** — Connection: use this figure to connect Person versus UserAccount, authentication sequence, password hashing concept, Map-based directories, threat-model-lite thinking, and AI security gates to the deeper lineage of programming languages, software design, computing practice, or professional judgment. Selection criteria: Wikipedia-accessible; final portrait pass should verify date/eligibility and avoid repeating figures across chapters. Example prompt: "Imagine Jerome H. Saltzer reviewing a student's INFO 5100 project for Person versus UserAccount, authentication sequence, password hashing concept, Map-based directories, threat-model-lite thinking, and AI security gates. Ask what evidence proves the student understood the design rather than merely accepted generated code."
- **Michael D. Schroeder** — Connection: use this figure to connect Person versus UserAccount, authentication sequence, password hashing concept, Map-based directories, threat-model-lite thinking, and AI security gates to the deeper lineage of programming languages, software design, computing practice, or professional judgment. Selection criteria: Wikipedia-accessible; final portrait pass should verify date/eligibility and avoid repeating figures across chapters. Example prompt: "Imagine Michael D. Schroeder reviewing a student's INFO 5100 project for Person versus UserAccount, authentication sequence, password hashing concept, Map-based directories, threat-model-lite thinking, and AI security gates. Ask what evidence proves the student understood the design rather than merely accepted generated code."
- **Butler Lampson** — Connection: use this figure to connect Person versus UserAccount, authentication sequence, password hashing concept, Map-based directories, threat-model-lite thinking, and AI security gates to the deeper lineage of programming languages, software design, computing practice, or professional judgment. Selection criteria: Wikipedia-accessible; final portrait pass should verify date/eligibility and avoid repeating figures across chapters. Example prompt: "Imagine Butler Lampson reviewing a student's INFO 5100 project for Person versus UserAccount, authentication sequence, password hashing concept, Map-based directories, threat-model-lite thinking, and AI security gates. Ask what evidence proves the student understood the design rather than merely accepted generated code."
...
An authentication sequence diagram should show username input, account lookup, hash comparison, success/failure result, and which object owns each responsibility.

---

## 8. Open Questions and Research Gaps

- Aging risk: High for security recommendations and NIST guidance; verify before each offering.
