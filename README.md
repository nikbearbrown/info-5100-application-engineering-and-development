...
- `images/info-5100-application-engineering-and-development-fig-NN.svg` — static SVG (→ PNG for EPUB)
- `d3/info-5100-application-engineering-and-development-fig-NN.html` — interactive D3 HTML
