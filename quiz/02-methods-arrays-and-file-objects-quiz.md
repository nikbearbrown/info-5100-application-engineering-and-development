...
- Explain the chapter-specific role of array of object references.
- Apply stack/reference/heap to a realistic project situation.
- Diagnose the common misconception: confusing a reference with the object itself.
...
In this module, what does **array of object references** help students understand?

A) References on the stack point to heap objects with separate instance fields.
...
Which answer best describes the misconception the chapter is trying to prevent about **stack/reference/heap**?

A) Confusing a reference with the object itself.
...
The chapter treats **stack/reference/heap** as something students must connect to a concrete artifact, not just define from memory.
...
If three array slots print the same title, the strongest response is to ignore the chapter mechanism and assume the program is correct because it opened or compiled.
...
Scenario: three array slots print the same title. What should the student do first?

A) Trace constructor calls, references stored in each index, and expected field values.
...
Name one piece of evidence that would show whether **array of object references** is working correctly in this module.
...
Why is the wrong approach, "confusing a reference with the object itself," risky in this chapter?
...
Apply **stack/reference/heap** to a new project feature. What would you inspect, and what evidence would convince you the design is defensible?
...
**Q1 - A**  
*Correct because:* References on the stack point to heap objects with separate instance fields.  
...
*Chapter reference:* array of object references

---

**Q2 - A**  
*Correct because:* The chapter specifically works against confusing a reference with the object itself.  
*Why the distractors are wrong:*  
...
*Chapter reference:* stack/reference/heap
...
**Q5 - A**  
*Correct because:* Trace constructor calls, references stored in each index, and expected field values.  
*Why the distractors are wrong:*  
...
**Q6 - Short-Answer**  
*Model answer:* Trace constructor calls, references stored in each index, and expected field values.  
*Chapter reference:* array of object references
...
**Q8 - Brief-Response**  
*Model answer:* A strong response should name the relevant artifact (array of object references), explain the mechanism (references on the stack point to heap objects with separate instance fields), and cite evidence such as trace constructor calls, references stored in each index, and expected field values.  
