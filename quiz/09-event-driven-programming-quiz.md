...
- Explain the chapter-specific role of Comparator and filtering workflow.
- Apply Comparator/Comparable/filtering to a realistic project situation.
- Diagnose the common misconception: using Comparable for every screen-specific sort.
...
In this module, what does **Comparator and filtering workflow** help students understand?

A) Comparator supplies alternate ordering rules while filtering selects matching records.
...
Which answer best describes the misconception the chapter is trying to prevent about **Comparator/Comparable/filtering**?

A) Using comparable for every screen-specific sort.
...
The chapter treats **Comparator/Comparable/filtering** as something students must connect to a concrete artifact, not just define from memory.
...
If the library needs title, due-date, and patron-name sorts, the strongest response is to ignore the chapter mechanism and assume the program is correct because it opened or compiled.
...
Scenario: the library needs title, due-date, and patron-name sorts. What should the student do first?

A) Use known input records and verify output order against the selected rule.
...
Name one piece of evidence that would show whether **Comparator and filtering workflow** is working correctly in this module.
...
Why is the wrong approach, "using Comparable for every screen-specific sort," risky in this chapter?
...
Apply **Comparator/Comparable/filtering** to a new project feature. What would you inspect, and what evidence would convince you the design is defensible?
...
**Q1 - A**  
*Correct because:* Comparator supplies alternate ordering rules while filtering selects matching records.  
...
*Chapter reference:* Comparator and filtering workflow

---

**Q2 - A**  
*Correct because:* The chapter specifically works against using Comparable for every screen-specific sort.  
*Why the distractors are wrong:*  
...
*Chapter reference:* Comparator/Comparable/filtering
...
**Q5 - A**  
*Correct because:* Use known input records and verify output order against the selected rule.  
*Why the distractors are wrong:*  
...
**Q6 - Short-Answer**  
*Model answer:* Use known input records and verify output order against the selected rule.  
*Chapter reference:* Comparator and filtering workflow
...
**Q8 - Brief-Response**  
*Model answer:* A strong response should name the relevant artifact (Comparator and filtering workflow), explain the mechanism (Comparator supplies alternate ordering rules while filtering selects matching records), and cite evidence such as use known input records and verify output order against the selected rule.  
