# Chapter Quiz: Module 10: Event-Driven Programming with Scene Builder
...
- Explain the chapter-specific role of JavaFX MVC TableView screen.
- Apply model/view/controller/TableView to a realistic project situation.
- Diagnose the common misconception: putting business decisions directly inside view controls.
...
In this module, what does **JavaFX MVC TableView screen** help students understand?

A) Controllers mediate between view events and model operations.
...
Which answer best describes the misconception the chapter is trying to prevent about **model/view/controller/TableView**?

A) Putting business decisions directly inside view controls.
...
The chapter treats **model/view/controller/TableView** as something students must connect to a concrete artifact, not just define from memory.
...
If a checkout button handler changes fields and decides policy itself, the strongest response is to ignore the chapter mechanism and assume the program is correct because it opened or compiled.
...
Scenario: a checkout button handler changes fields and decides policy itself. What should the student do first?

A) Move business rules into model methods and refresh the tableview from results.
...
Name one piece of evidence that would show whether **JavaFX MVC TableView screen** is working correctly in this module.
...
Why is the wrong approach, "putting business decisions directly inside view controls," risky in this chapter?
...
Apply **model/view/controller/TableView** to a new project feature. What would you inspect, and what evidence would convince you the design is defensible?
...
**Q1 - A**  
*Correct because:* Controllers mediate between view events and model operations.  
...
*Chapter reference:* JavaFX MVC TableView screen

---

**Q2 - A**  
*Correct because:* The chapter specifically works against putting business decisions directly inside view controls.  
*Why the distractors are wrong:*  
...
*Chapter reference:* model/view/controller/TableView
...
**Q5 - A**  
*Correct because:* Move business rules into model methods and refresh the tableview from results.  
*Why the distractors are wrong:*  
...
**Q6 - Short-Answer**  
*Model answer:* Move business rules into model methods and refresh the tableview from results.  
*Chapter reference:* JavaFX MVC TableView screen
...
**Q8 - Brief-Response**  
*Model answer:* A strong response should name the relevant artifact (JavaFX MVC TableView screen), explain the mechanism (controllers mediate between view events and model operations), and cite evidence such as move business rules into model methods and refresh the TableView from results.  
