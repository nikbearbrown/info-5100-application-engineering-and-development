...
- Explain the chapter-specific role of FXML controller mapping.
- Apply FXML/fx:id/@FXML/initialize to a realistic project situation.
- Diagnose the common misconception: assuming Scene Builder wiring replaces controller logic.
...
In this module, what does **FXML controller mapping** help students understand?

A) Matching fx:id, @fxml fields, and handler methods connect the view to controller code.
...
Which answer best describes the misconception the chapter is trying to prevent about **FXML/fx:id/@FXML/initialize**?

A) Assuming scene builder wiring replaces controller logic.
...
The chapter treats **FXML/fx:id/@FXML/initialize** as something students must connect to a concrete artifact, not just define from memory.
...
If a button appears but its controller action never fires, the strongest response is to ignore the chapter mechanism and assume the program is correct because it opened or compiled.
...
Scenario: a button appears but its controller action never fires. What should the student do first?

A) Check fx:id, onaction, controller class, method name, and initialize setup.
...
Name one piece of evidence that would show whether **FXML controller mapping** is working correctly in this module.
...
Why is the wrong approach, "assuming Scene Builder wiring replaces controller logic," risky in this chapter?
...
Apply **FXML/fx:id/@FXML/initialize** to a new project feature. What would you inspect, and what evidence would convince you the design is defensible?
...
**Q1 - A**  
*Correct because:* Matching fx:id, @fxml fields, and handler methods connect the view to controller code.  
...
*Chapter reference:* FXML controller mapping

---

**Q2 - A**  
*Correct because:* The chapter specifically works against assuming Scene Builder wiring replaces controller logic.  
*Why the distractors are wrong:*  
...
*Chapter reference:* FXML/fx:id/@FXML/initialize
...
**Q5 - A**  
*Correct because:* Check fx:id, onaction, controller class, method name, and initialize setup.  
*Why the distractors are wrong:*  
...
**Q6 - Short-Answer**  
*Model answer:* Check fx:id, onaction, controller class, method name, and initialize setup.  
*Chapter reference:* FXML controller mapping
...
**Q8 - Brief-Response**  
*Model answer:* A strong response should name the relevant artifact (FXML controller mapping), explain the mechanism (matching fx:id, @FXML fields, and handler methods connect the view to controller code), and cite evidence such as check fx:id, onAction, controller class, method name, and initialize setup.  
