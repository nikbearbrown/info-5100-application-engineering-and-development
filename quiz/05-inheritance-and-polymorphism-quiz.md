...
- Explain the chapter-specific role of entity, transaction, and catalog model.
- Apply entity/transaction/catalog to a realistic project situation.
- Diagnose the common misconception: treating every project object as the same kind of object.
...
In this module, what does **entity, transaction, and catalog model** help students understand?

A) Durable entities, event transactions, and catalog/query objects have different responsibilities.
...
Which answer best describes the misconception the chapter is trying to prevent about **entity/transaction/catalog**?

A) Treating every project object as the same kind of object.
...
The chapter treats **entity/transaction/catalog** as something students must connect to a concrete artifact, not just define from memory.
...
If CheckoutRecord updates Book and Patron state, the strongest response is to ignore the chapter mechanism and assume the program is correct because it opened or compiled.
...
Scenario: CheckoutRecord updates Book and Patron state. What should the student do first?

A) Classify objects before deciding where relationships and queries belong.
...
Name one piece of evidence that would show whether **entity, transaction, and catalog model** is working correctly in this module.
...
Why is the wrong approach, "treating every project object as the same kind of object," risky in this chapter?
...
Apply **entity/transaction/catalog** to a new project feature. What would you inspect, and what evidence would convince you the design is defensible?
...
**Q1 - A**  
*Correct because:* Durable entities, event transactions, and catalog/query objects have different responsibilities.  
...
*Chapter reference:* entity, transaction, and catalog model

---

**Q2 - A**  
*Correct because:* The chapter specifically works against treating every project object as the same kind of object.  
*Why the distractors are wrong:*  
...
*Chapter reference:* entity/transaction/catalog
...
**Q5 - A**  
*Correct because:* Classify objects before deciding where relationships and queries belong.  
*Why the distractors are wrong:*  
...
**Q6 - Short-Answer**  
*Model answer:* Classify objects before deciding where relationships and queries belong.  
*Chapter reference:* entity, transaction, and catalog model
...
**Q8 - Brief-Response**  
*Model answer:* A strong response should name the relevant artifact (entity, transaction, and catalog model), explain the mechanism (durable entities, event transactions, and catalog/query objects have different responsibilities), and cite evidence such as classify objects before deciding where relationships and queries belong.  
