...
- Explain the chapter-specific role of CardLayout two-screen flow.
- Apply object lifecycle across panels to a realistic project situation.
- Diagnose the common misconception: using static variables to hide state-passing problems.
...
In this module, what does **CardLayout two-screen flow** help students understand?

A) Screen changes must preserve the selected domain object across panels.
...
Which answer best describes the misconception the chapter is trying to prevent about **object lifecycle across panels**?

A) Using static variables to hide state-passing problems.
...
The chapter treats **object lifecycle across panels** as something students must connect to a concrete artifact, not just define from memory.
...
If Screen 2 loses the patron selected on Screen 1, the strongest response is to ignore the chapter mechanism and assume the program is correct because it opened or compiled.
...
Scenario: Screen 2 loses the patron selected on Screen 1. What should the student do first?

A) Trace where the selected object reference is passed, stored, or retrieved.
...
Name one piece of evidence that would show whether **CardLayout two-screen flow** is working correctly in this module.
...
Why is the wrong approach, "using static variables to hide state-passing problems," risky in this chapter?
...
Apply **object lifecycle across panels** to a new project feature. What would you inspect, and what evidence would convince you the design is defensible?
...
**Q1 - A**  
*Correct because:* Screen changes must preserve the selected domain object across panels.  
...
*Chapter reference:* CardLayout two-screen flow

---

**Q2 - A**  
*Correct because:* The chapter specifically works against using static variables to hide state-passing problems.  
*Why the distractors are wrong:*  
...
*Chapter reference:* object lifecycle across panels
...
**Q5 - A**  
*Correct because:* Trace where the selected object reference is passed, stored, or retrieved.  
*Why the distractors are wrong:*  
...
**Q6 - Short-Answer**  
*Model answer:* Trace where the selected object reference is passed, stored, or retrieved.  
*Chapter reference:* CardLayout two-screen flow
...
**Q8 - Brief-Response**  
*Model answer:* A strong response should name the relevant artifact (CardLayout two-screen flow), explain the mechanism (screen changes must preserve the selected domain object across panels), and cite evidence such as trace where the selected object reference is passed, stored, or retrieved.  
